...
public:
    ...
    __aicore__ inline void Process()
    {
        ...
        AIV_WITH_BARRIER(ShiftRight, mergeLocal[computeNum0 * 2 / 16], mergeLocal, (uint16_t)8, computeNum0 * 2 / 16);
        AIV_WITH_BARRIER(ShiftRight, mergeLocal[computeNum0 * 2 / 16 * 2], mergeLocal, (uint16_t)4, computeNum0 * 2 / 16 * 2);
        AIV_WITH_BARRIER(ShiftRight, mergeLocal[computeNum0 * 2 / 16 * 4], mergeLocal, (uint16_t)2, computeNum0 * 2 / 16 * 4);
